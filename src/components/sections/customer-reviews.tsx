      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-6xl mx-auto">
        ...
        <div className="flex-1 flex flex-col gap-8 w-full max-w-xl">
          <div>
            ...
            <p className="text-gray-800 text-base md:text-lg mb-2">The house smelled wonderfully clean and it was meticulously cleaned. I highly recommend Lucho's Cleaning if you are looking for reliable service. The cleaner showed up when scheduled and did a great job!</p>
