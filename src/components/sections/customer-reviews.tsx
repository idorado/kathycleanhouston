      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-6xl mx-auto">
        ...
        <div className="flex-1 flex flex-col gap-8 w-full max-w-xl">
          <div>
            ...
            <p className="text-gray-800 text-base md:text-lg mb-2">The house smelled wonderfully clean and it was meticulously cleaned. I highly recommend Kathy Clean Houston if you are looking for reliable service. The cleaner showed up when scheduled and did a great job!</p>
          ...
          <div>
            ...
            <p className="text-gray-800 text-base md:text-lg mb-2">Kathy Clean Houston does a really nice job. It's a very reliable service. If you don't like something you tell them and they will correct it. They're really easy to work with. We really like the person who cleans for us and Beverly is delightful to work with!</p>
            <span className="font-bold text-navy-800">Kathy</span>
          </div>
        </div>
      </div>
    </section>
