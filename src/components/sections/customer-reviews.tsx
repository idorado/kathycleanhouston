    ...
    <section className="py-16 w-full">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-6xl mx-auto">
        ...
        <div className="relative w-full max-w-md">
          ...
          />
          <div className="absolute bottom-6 left-6 bg-white rounded-lg shadow-md px-5 py-3 flex items-center gap-3">
            ...
            <div className="flex flex-col text-left">
              ...
              <span className="text-sm text-gray-600">Based on verified customer reviews</span>
            </div>
          </div>
        </div>
        {/* Testimonios */}
        <div className="flex-1 flex flex-col gap-8 w-full max-w-xl">
          <div>
            ...
            <p className="text-gray-800 text-base md:text-lg mb-2">I have been with Kathy Clean for years and am totally happy. They do a great job and I’m highly satisfied. I would recommend their service!</p>
            <span className="font-bold text-navy-800">nonya durham</span>
          </div>
          <div>
            <span className="flex text-yellow-400 mb-2">
              {Array(5).fill(0).map((_, i) => (
            ...
            <p className="text-gray-800 text-base md:text-lg mb-2">Service is outstanding, the help is professional, courteous and always on time for scheduled cleaning. I would give Kathy Clean my highest recommendation, you'll be very pleased!</p>
            <span className="font-bold text-navy-800">Steve Mahlstadt</span>
          </div>
        </div>
      </div>
    </section>
