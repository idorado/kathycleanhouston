      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <div>
            ...
            <div className="mb-6">
              <h4 className="text-ring font-medium mb-2">ADDRESS</h4>
              <p className="text-white">7500 East Arapahoe Road,</p>
              <p className="text-white">Centennial, CO 80112</p>
            </div>
            
            <div className="mb-6">
              <h4 className="text-ring font-medium mb-2">CONTACT US</h4>
              <div className="flex items-center gap-2 mb-2">
                <div className="bg-ring rounded-full p-1.5">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-secondary-foreground" aria-hidden="true" role="img" aria-label="Phone">
                    <title>Phone</title>
              ...
              <div className="flex items-center gap-2">
                <div className="bg-ring rounded-full p-1.5">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-secondary-foreground" aria-hidden="true" role="img" aria-label="Email">
                    <title>Email</title>
          ...
          <div>
            <h3 className="text-xl font-semibold text-ring mb-6">Services</h3>
          ...
          <div>
            <h3 className="text-xl font-semibold text-ring mb-6">Kathy Clean</h3>
            <ul className="space-y-4">
        ...
        <div className="border-t border-ring pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-ring">
          <p>© {new Date().getFullYear()} Kathy Clean. All rights reserved.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link href="/privacy" className="text-ring">Privacy Policy</Link>
            <Link href="/terms" className="text-ring">Terms of Service</Link>
            <button type="button" className="text-ring">Cookies Settings</button>
          </div>
        </div>
      </div>
    </footer>
