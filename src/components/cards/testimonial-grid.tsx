...
export function Testimonial() {
  ...
  return (
    <div className="w-full py-12">
      <div className="w-full max-w-full md:max-w-4xl lg:max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {testimonials.map((testimonial) => (
          <Card key={testimonial.id} className="h-[500px]">
