      ...
      <HeroSection>
        <div className="space-y-4 md:space-y-6 py-16 text-white text-center md:text-left">
          ...
          <p className="text-base sm:text-lg mb-6">
            ...
            Lucho's Cleaning delivers affordable, top-rated cleanings backed by a team with years of experience and satisfied customers in {displayLocation} {isDenverArea ? 'and throughout the Houston metro area' : 'and surrounding areas'}.
          </p>
