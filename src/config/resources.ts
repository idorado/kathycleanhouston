...
export const resourceArticles: ResourceArticle[] = [
  ...
  {
    slug: "recurring-cleaning-cost-houston",
    title: "Recurring House Cleaning Cost in Houston: Weekly, Bi-Weekly & Monthly",
    description: "What recurring house cleaning costs in Houston — weekly from $129, bi-weekly from $139, monthly from $149 per visit. How frequency changes the per-visit price and your annual cost.",
    publishDate: "2026-06-24",
    category: "pricing",
    readTime: 5,
  },
  {
    slug: "apartment-cleaning-cost-houston",
    title: "How Much Does Apartment Cleaning Cost in Houston?",
    description: "Apartment cleaning in Houston is priced by square footage — bi-weekly from $139, one-time from $199. Full pricing for studios to 1,500 sq ft units, plus what a clean includes.",
    publishDate: "2026-06-24",
    category: "pricing",
    readTime: 4,
  },
  {
    slug: "house-cleaning-cost-katy",
    title: "House Cleaning Cost in Katy, TX: Flat-Rate Pricing Guide",
    description: "Flat-rate house cleaning prices for Katy and Cinco Ranch homes — recurring from $129, deep clean from $285. Same transparent pricing across Katy, no neighborhood surcharge.",
    publishDate: "2026-06-24",
    category: "pricing",
    readTime: 5,
  },
