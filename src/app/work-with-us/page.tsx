...
const translations = {
  en: {
    ...
    video: 'Record a video about your experience and why you want to work at Kathy Clean',
    submit: 'Submit',
    language: 'Language',
    uploading: 'Uploading...',
  ...
  es: {
    ...
    video: 'Graba un video contándonos sobre tus últimas experiencias y por qué te interesa trabajar en Kathy Clean',
    submit: 'Enviar',
    language: 'Idioma',
    uploading: 'Subiendo...',
